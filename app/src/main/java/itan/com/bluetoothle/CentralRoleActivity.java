...
public class CentralRoleActivity extends BluetoothActivity implements View.OnClickListener, DevicesAdapter.DevicesAdapterListener {
    ...
    private List<ScanFilter> buildScanFilters() {
        ...
        builder.setServiceUuid(new ParcelUuid(Constants.HEART_RATE_SERVICE_UUID));
        //builder.setDeviceName("TSP-3");
    ...
    private class SampleScanCallback extends ScanCallback {
        ...
        public void onBatchScanResults(List<ScanResult> results) {
            ...
            android.util.Log.i("luke", "onBatchScanResults");
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            android.util.Log.i("luke", "dn:" + result.getDevice().getName());
            //try {
            //    android.util.Log.i("luke", "dn:" + result.getDevice().getName());
            //    if (result.getDevice().getName().contains("TSP")) {
