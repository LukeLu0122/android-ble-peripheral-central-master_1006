...
public class DeviceConnectActivity extends BluetoothActivity implements View.OnClickListener {
    ...
    private Button mResetReadCharacteristic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mResetReadCharacteristic = (Button) findViewById(R.id.request_write_characteristic);
        mResetReadCharacteristic.setOnClickListener(this);
